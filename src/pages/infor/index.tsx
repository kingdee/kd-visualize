      ...
      <div className={'screen'}>
        <div className="common_wrapper">
          <div className="common_header">
            <div className="common_header_logo"  onClick={() => history.goBack()}></div>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <span className="card_digit small yellow">万</span>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <table>
                      <tbody>
                        ...
                        <tr>
                          <td className="card_text">累计成交金额</td>
                          <td>
                            <span className="card_digit big yellow">8,660</span>
                            <span className="card_digit small yellow">万</span>
                          </td>
                        </tr>
                      </tbody>
